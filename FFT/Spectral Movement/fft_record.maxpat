...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.980392156862745, 0.784313725490196, 0.784313725490196, 1.0 ],
					"id" : "obj-21",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 666.999999999999886, 249.0, 35.0, 22.0 ],
					"text" : "out 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 504.833333333333258, 143.0, 46.666666666666742, 22.0 ],
					"text" : "*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 418.833333333333258, 185.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 357.000008940696716, 275.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 357.000008940696716, 275.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 666.999999999999886, 136.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "int", "int", "int" ],
					"patching_rect" : [ 733.833333333333258, 78.0, 94.5, 22.0 ],
					"text" : "fftinfo~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 666.999999999999886, 208.0, 189.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.999999999999886, 167.0, 28.0, 22.0 ],
					"text" : "in 3",
					"textcolor" : [ 0.184313725490196, 0.16078431372549, 0.16078431372549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 712.999999999999886, 54.0, 28.0, 22.0 ],
					"text" : "in 2",
					"textcolor" : [ 0.184313725490196, 0.16078431372549, 0.16078431372549, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 514.333333333333258, 103.0, 567.0, 103.0 ],
					"order" : 0,
					"source" : [ "obj-4", 1 ]
				}
